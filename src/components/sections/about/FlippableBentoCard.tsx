...
export function FlippableBentoCard({
    ...
    return (
        <div
            className={cn(
                "row-span-1 rounded-xl group/bento hover:shadow-xl transition duration-200 shadow-input dark:shadow-none dark:bg-black dark:border-white/[0.2] bg-white border border-transparent justify-between flex flex-col space-y-4 perspective-1000 cursor-pointer",
                className
            )}
            onClick={handleFlip}
        >
